...
import { blogArticles, blogCategories, blogSEO } from "./articles";
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            Blog{" "}
            <span className="text-blue-600">Plannitech</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Découvrez nos conseils, guides pratiques et témoignages pour optimiser 
            votre gestion d'événements culturels.
          </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedCard className="overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredArticles.map((article, index) => (
              <AnimatedCard key={article.id} delay={index * 0.1} className="overflow-hidden hover:shadow-lg transition-shadow">
          ...
          {/* Load More */}
          <AnimatedButton className="text-center mt-12">
