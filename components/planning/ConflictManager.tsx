...
export function ConflictManager({ 
  ...
  const fetchConflicts = async () => {
    try {
      ...
      // Simuler la récupération des conflits
      const mockConflicts: Conflict[] = [
        {
          id: '1',
          type: 'time',
          severity: 'high',
          title: 'Conflit horaire - Setup et Répétition',
          description: 'Le setup de la scène et la répétition générale se chevauchent dans le temps.',
          items: [
            {
              id: 'setup-1',
              title: 'Setup scène',
          ...
          suggestions: [
            {
              id: 's1',
              title: 'Décaler la répétition',
              description: 'Déplacer la répétition à 18h30 pour laisser le temps au setup',
              impact: 'low',
              action: 'move_rehearsal'
            },
            {
              id: 's2',
              title: 'Accélérer le setup',
              description: 'Réduire le temps de setup à 2h30 en ajoutant une personne',
              impact: 'medium',
              action: 'accelerate_setup'
            }
          ],
          resolved: false,
        ...
        },
        {
          ...
          type: 'resource',
          severity: 'medium',
          title: 'Surcharge équipement - Console de mixage',
          description: 'La console de mixage est demandée simultanément pour deux spectacles.',
          items: [
            {
              id: 'show-1',
              title: 'Concert Jazz',
            ...
            },
            {
              ...
              startTime: '2024-02-15T20:30:00Z',
              endTime: '2024-02-15T22:30:00Z',
              type: 'performance',
          ...
          suggestions: [
            {
              id: 's3',
              title: 'Louer une console supplémentaire',
              description: 'Louer une console de mixage pour le second spectacle',
              impact: 'medium',
              action: 'rent_equipment'
            },
            {
              id: 's4',
              title: 'Décaler un spectacle',
              description: 'Déplacer le spectacle théâtre à 21h00',
              impact: 'high',
              action: 'reschedule_show'
            }
          ],
          resolved: false,
        ...
        },
        {
          ...
          type: 'team',
          severity: 'critical',
          title: 'Membre d\'équipe double assigné',
          description: 'Marie Dubois est assignée à deux tâches simultanées.',
          items: [
            {
              id: 'task-1',
              title: 'Setup éclairage',
              startTime: '2024-02-15T14:00:00Z',
            ...
            },
            {
              ...
              endTime: '2024-02-15T17:00:00Z',
              type: 'rehearsal',
              assignedTo: ['Marie Dubois', 'Sarah Johnson']
            }
          ],
          suggestions: [
            {
              ...
              description: 'Confier le setup éclairage à Jean Martin uniquement',
              impact: 'low',
              action: 'reassign_task'
            },
            {
              id: 's6',
              title: 'Décaler une tâche',
              description: 'Déplacer la répétition technique à 17h00',
              impact: 'medium',
